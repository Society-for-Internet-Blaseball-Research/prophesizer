...
SELECT pg_catalog.setval('data.game_event_base_runners_id_seq', 7463566, true);
...
SELECT pg_catalog.setval('data.player_events_id_seq', 42687, true);
...
SELECT pg_catalog.setval('data.player_modifications_player_modifications_id_seq', 2498, true);
...
SELECT pg_catalog.setval('data.players_id_seq', 78135, true);
...
SELECT pg_catalog.setval('data.team_modifications_team_modifications_id_seq', 268, true);
...
SELECT pg_catalog.setval('data.team_positions_team_position_id_seq', 17179, true);
...
SELECT pg_catalog.setval('data.teams_id_seq', 595, true);
...
SELECT pg_catalog.setval('data.time_map_time_map_id_seq', 8479292, true);
