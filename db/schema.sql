 ...
 SELECT y.that AS record,
   ...
   FROM ( SELECT x.that,
           ...
           FROM ( SELECT count(1) AS that,
                  ...
                  WHERE ((game_events.event_type <> ALL (ARRAY['UNKNOWN'::text, 'OUT'::text])) AND (game_events.day >= 99))
 ...
 SELECT y.that AS record,
   ...
   FROM (( SELECT x.that,
           ...
           FROM ( SELECT count(1) AS that,
                    ...
                    game_events.day
                   FROM data.game_events
                  WHERE ((game_events.event_type <> ALL (ARRAY['HIT_BY_PITCH'::text, 'UNKNOWN'::text, 'OUT'::text])) AND (game_events.day >= 99))
...
SELECT pg_catalog.setval('data.game_event_base_runners_id_seq', 3997733, true);
...
SELECT pg_catalog.setval('data.game_events_id_seq', 4595937, true);
...
SELECT pg_catalog.setval('data.imported_logs_id_seq', 28546, true);
...
SELECT pg_catalog.setval('data.player_events_id_seq', 3780, true);
...
SELECT pg_catalog.setval('data.player_modifications_player_modifications_id_seq', 1284, true);
...
SELECT pg_catalog.setval('data.players_id_seq', 47960, true);
...
SELECT pg_catalog.setval('data.team_positions_team_position_id_seq', 10557, true);
...
SELECT pg_catalog.setval('data.time_map_time_map_id_seq', 4595869, true);
