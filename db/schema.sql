...
SELECT pg_catalog.setval('data.game_event_base_runners_id_seq', 5559942, true);
...
SELECT pg_catalog.setval('data.player_events_id_seq', 8726, true);
...
SELECT pg_catalog.setval('data.player_modifications_player_modifications_id_seq', 1773, true);
...
SELECT pg_catalog.setval('data.players_id_seq', 69016, true);
...
SELECT pg_catalog.setval('data.team_modifications_team_modifications_id_seq', 200, true);
...
SELECT pg_catalog.setval('data.team_positions_team_position_id_seq', 15189, true);
...
SELECT pg_catalog.setval('data.teams_id_seq', 521, true);
...
SELECT pg_catalog.setval('data.time_map_time_map_id_seq', 6136679, true);
