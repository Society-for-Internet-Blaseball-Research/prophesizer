...
SELECT pg_catalog.setval('data.chronicler_hash_game_event_chronicler_hash_game_event_id_seq', 2450529, true);
...
SELECT pg_catalog.setval('data.game_event_base_runners_id_seq', 9019291, true);
...
SELECT pg_catalog.setval('data.player_events_id_seq', 56716, true);
...
SELECT pg_catalog.setval('data.player_modifications_player_modifications_id_seq', 4042, true);
...
SELECT pg_catalog.setval('data.players_id_seq', 92747, true);
...
SELECT pg_catalog.setval('data.team_modifications_team_modifications_id_seq', 524, true);
...
SELECT pg_catalog.setval('data.team_positions_team_position_id_seq', 21105, true);
...
SELECT pg_catalog.setval('data.teams_id_seq', 741, true);
...
SELECT pg_catalog.setval('data.time_map_time_map_id_seq', 10372755, true);
