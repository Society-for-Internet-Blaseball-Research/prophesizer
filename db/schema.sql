...
SELECT pg_catalog.setval('data.game_event_base_runners_id_seq', 5094391, true);
...
SELECT pg_catalog.setval('data.player_events_id_seq', 5112, true);
...
SELECT pg_catalog.setval('data.players_id_seq', 64561, true);
...
SELECT pg_catalog.setval('data.team_modifications_team_modifications_id_seq', 166, true);
...
SELECT pg_catalog.setval('data.team_positions_team_position_id_seq', 14194, true);
...
SELECT pg_catalog.setval('data.teams_id_seq', 484, true);
