...
CREATE VIEW data.pitching_stats_all_appearances AS
 SELECT ge.game_id,
  ...
  GROUP BY ge.season, ge.day, ge.game_id, ge.pitcher_id, ge.top_of_inning, fs.home_final, fs.away_final;
...
SELECT pg_catalog.setval('data.game_event_base_runners_id_seq', 2902940, true);
...
SELECT pg_catalog.setval('data.game_events_id_seq', 3329634, true);
...
SELECT pg_catalog.setval('data.imported_logs_id_seq', 21158, true);
...
SELECT pg_catalog.setval('data.player_events_id_seq', 2589, true);
...
SELECT pg_catalog.setval('data.player_modifications_player_modifications_id_seq', 899, true);
...
SELECT pg_catalog.setval('data.players_id_seq', 36297, true);
...
SELECT pg_catalog.setval('data.team_positions_team_position_id_seq', 8028, true);
...
SELECT pg_catalog.setval('data.teams_id_seq', 271, true);
...
SELECT pg_catalog.setval('data.time_map_time_map_id_seq', 3329566, true);
