...
ALTER TABLE IF EXISTS taxa.tournaments ALTER COLUMN tournament_db_id DROP DEFAULT;
ALTER TABLE IF EXISTS taxa.tournament_teams ALTER COLUMN tournament_team_id DROP DEFAULT;
...
--
-- Name: tournament_teams tournament_team_id; Type: DEFAULT; Schema: taxa; Owner: -
--

ALTER TABLE ONLY taxa.tournament_teams ALTER COLUMN tournament_team_id SET DEFAULT nextval('taxa.tournament_teams_tournament_team_id_seq'::regclass);


--
-- Name: tournaments tournament_db_id; Type: DEFAULT; Schema: taxa; Owner: -
--

ALTER TABLE ONLY taxa.tournaments ALTER COLUMN tournament_db_id SET DEFAULT nextval('taxa.tournaments_tournament_db_id_seq'::regclass);
...
3	b4e9dc19-7e3f-4532-4c68-fcda19071d16
4	d9e4812a-0e79-4c11-7a07-99f1556d4b48
\.
...
SELECT pg_catalog.setval('data.applied_patches_patch_id_seq', 4, true);
...
SELECT pg_catalog.setval('data.chronicler_hash_game_event_chronicler_hash_game_event_id_seq', 19453331, true);
...
SELECT pg_catalog.setval('data.game_event_base_runners_id_seq', 12689155, true);
...
SELECT pg_catalog.setval('data.player_events_id_seq', 77006, true);
...
SELECT pg_catalog.setval('data.player_modifications_player_modifications_id_seq', 10180, true);
...
SELECT pg_catalog.setval('data.players_id_seq', 125639, true);
...
SELECT pg_catalog.setval('data.team_modifications_team_modifications_id_seq', 2083, true);
...
SELECT pg_catalog.setval('data.team_positions_team_position_id_seq', 29588, true);
...
SELECT pg_catalog.setval('data.teams_id_seq', 1125, true);
...
SELECT pg_catalog.setval('data.time_map_time_map_id_seq', 16629174, true);
...
--
-- Name: tournament_teams_tournament_team_id_seq; Type: SEQUENCE SET; Schema: taxa; Owner: -
--

SELECT pg_catalog.setval('taxa.tournament_teams_tournament_team_id_seq', 16, true);


--
-- Name: tournaments_tournament_db_id_seq; Type: SEQUENCE SET; Schema: taxa; Owner: -
--

SELECT pg_catalog.setval('taxa.tournaments_tournament_db_id_seq', 1, true);
