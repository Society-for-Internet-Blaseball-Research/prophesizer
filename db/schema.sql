...
SELECT pg_catalog.setval('data.game_event_base_runners_id_seq', 3955023, true);
...
SELECT pg_catalog.setval('data.game_events_id_seq', 4544615, true);
...
SELECT pg_catalog.setval('data.imported_logs_id_seq', 28280, true);
...
SELECT pg_catalog.setval('data.player_events_id_seq', 3677, true);
...
SELECT pg_catalog.setval('data.player_modifications_player_modifications_id_seq', 1236, true);
...
SELECT pg_catalog.setval('data.players_id_seq', 47760, true);
...
SELECT pg_catalog.setval('data.team_positions_team_position_id_seq', 10544, true);
...
SELECT pg_catalog.setval('data.time_map_time_map_id_seq', 4544547, true);
