...
internal class InsertCommand
{
	...
	/// <param name="tableName">Name of table to insert into</param>
	/// <param name="obj">Object to insert</param>
	private void Populate(string tableName, object obj, Dictionary<string, object> extraFields, string returnColumn = "id", string append = "")
	{
		...
		query.Append(append);
		query.Append($" RETURNING {returnColumn};");
