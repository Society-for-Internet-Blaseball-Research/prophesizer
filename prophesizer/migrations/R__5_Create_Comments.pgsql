-- LAST UPDATE: 5/2/2021 created comments migration

--Public schema
COMMENT ON public.changelog IS 'Used by Prophesizer to keep track of versioining and migration scripts.  Should be truncated (As well as dropping data and taxa schemas) before a full database refresh.';
...
COMMENT ON table taxa.modifications IS 'Manually pulled on occasion from main.js.  Please note some of these Modifications may still be FK.';
